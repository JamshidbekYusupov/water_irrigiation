...
from src.data_preprocesssing import PreprocessingPipeline\
...
dp = PreprocessingPipeline(df=df, target=target)
dp.feature_prep()
X_train, y_train= dp.fit_transform()
X_test, y_test = dp.transform()
